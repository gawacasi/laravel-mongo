...
@section('content')
    <div class="container">
        <h1>Specific Victories</h1>
        <form action="{{ route('specific.victories') }}" method="GET">
            <div class="form-group">
                <label for="cardName">Card Name</label>
                <input type="text" id="cardName" name="cardName" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="trophyDifference">Trophy Difference</label>
                <input type="number" id="trophyDifference" name="trophyDifference" class="form-control" required>
            </div>
            <div class="form-group">
